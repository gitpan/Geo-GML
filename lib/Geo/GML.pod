...
Geo::GML-E<gt>B<addSchemaDirs>(DIRECTORIES|FILENAME)
...
Geo::GML-E<gt>B<dataToXML>(NODE|REF-XML-STRING|XML-STRING|FILENAME|FILEHANDLE|KNOWN)
...
Geo::GML-E<gt>B<findSchemaFile>(FILENAME)
...
Geo::GML-E<gt>B<knownNamespace>(NAMESPACE|PAIRS)
...
This module is part of Geo-GML distribution version 0.14,
built on February 03, 2009. Website: F<http://perl.overmeer.net/geo/>
